...
var db_1 = require("./db");
var cache = {};
function updateCacheForSite(website) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4, (0, db_1.getRandomWebsite)(website.id)];
                case 1:
                    random = _a.sent();
                    cachedSite = cache[website.id] = {
...
function getCachedWidgetData(website) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!!cache[website.id]) return [3, 2];
                    return [4, updateCacheForSite(website)];
                case 1:
                    _a.sent();
                    _a.label = 2;
                case 2: return [2, cache[website.id]];
            }
        });
    });
}
